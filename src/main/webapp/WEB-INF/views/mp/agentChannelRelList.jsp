...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row wrapper border-bottom white-bg page-heading" id="breadcrumbsDiv">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li><a>代理商列表</a></li>
						<li class="active"><strong>代理商特惠通道列表</strong></li>
					</ol>
				</div>
			</div>
			...
			<div class="wrapper wrapper-content animated fadeInRight ecommerce">
				<!-- 查询模块 -->
				<div class="ibox-content m-b-sm border-bottom" id="queryDiv" data-agentId="${agentId}" data-groupId="${groupId }">
					<form>
						<div class="row">
							<div class="col-md-6">
		                        <div class="form-group">
		                            <label class="control-label" for="name">运营商物理通道</label>
		                            <input type="text" id="physicalName" name="physicalName" value="" placeholder="请输入运营商物理通道" class="form-control">
		                        </div>
		                    </div>
		                    <div class="col-md-6">
		                        <div class="form-group">
	...
	<script type="text/javascript" charset="UTF-8" src="${basePath }js/project/mp/agentChannelRelList.js"></script>
</body>
</html>
