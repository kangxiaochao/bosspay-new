		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a>系统管理</a></li>
					<li class="active"><strong>信息匹配详情</strong></li>
				</ol>
			</div>
		</div>
					...
					<div class="ibox-content">
						<form id="upload" method="post" action="" enctype="multipart/form-data"  class="form-horizontal">
							<div class="form-group">
								...
								<span class="help-block m-b-none">文件格式必须为.xlsx</span>
							</div>
							<div class="form-group">
								<div class="col-md-4 col-md-offset-2">
									<button type="reset" class="btn btn-warning">重置</button>
									<shiro:hasPermission name="addbatchOfCharger:post"><input type="submit" class="btn btn-primary" value="对比"></shiro:hasPermission>
								</div>
							</div>
						</form>
