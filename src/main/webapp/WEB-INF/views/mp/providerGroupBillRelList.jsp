...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row wrapper border-bottom white-bg page-heading" id="breadcrumbsDiv">
				<div class="col-lg-10">
					<h3>${groupMap.name }&nbsp;--&nbsp;话费通道组详情列表</h3>
					<ol class="breadcrumb">
						<li><a href="${basePath }mainPage">主页</a></li>
						<li><a>话费通道组</a></li>
						<li class="active"><strong>话费通道详情列表</strong></li>
					</ol>
				</div>
			</div>
			...
			<div class="wrapper wrapper-content animated fadeInRight ecommerce">
				...
				<input id="groupId" name="groupId" value="${groupMap.id}" type="hidden"/>
				<!-- 列表模块 -->
	...
	<script type="text/javascript" charset="UTF-8" src="${basePath }js/project/mp/providerGroupBillRelList.js"></script>
</body>
</html>
