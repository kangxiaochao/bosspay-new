...
<body>
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="form-group">
				            ...
				            <%-- <div class="col-md-12">
								<form id="uploadForm1" name="uploadForm" method="post" action="${basePath }providerBillDiscountEx1" enctype="multipart/form-data">
			            			...
			            			<div class="fileinput fileinput-new" data-provides="fileinput">
									    ...
									    <span class="fileinput-exists">重新选择</span><input type="file" name="providerBillDiscountFile" id="providerBillDiscountFile" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"/></span>
						...
						<div class="form-group">
				            ...
				            <div class="form-group col-sm-11">
				            	<select data-placeholder="请选择..." class="chosen-select" tabindex="2" name="providerId" id="providerId" onchange="initProvinceCode();getProviderBillPkg()"></select>
				            </div>
				        </div>
				        <div class="form-group">
				        ...
				        <div class="form-group">
				            ...
				            <div class="form-group col-sm-11">
				            	<select required data-placeholder="请选择..." class="chosen-select" name="provinceCode" id="provinceCode" onchange="getProviderBillPkg()"></select>
				            </div>
				        </div>
				        <div class="form-group">
				        ...
				        <div class="form-group">
				        	<label class="col-sm-1 control-label" style="padding-left: 0px;padding-right: 0px;">设置选中实际折扣</label>
				            <div class="form-group col-sm-11">
				            	<input id="realDis" type="number" class="form-control" onchange="updataRealDiscount()" min="0.001" step="0.001"/>
				            </div>
				        </div>
						<div class="form-group">
							<label class="col-sm-1 control-label" style="padding-left: 0px;padding-right: 0px;">折扣设置</label>
							<div class="col-md-11" id="provinceBillDiscount"></div>
				        </div>
				        
				        <div class="form-group">
				            <div class="col-sm-4 col-sm-offset-4">
				            	<button type="button" class="btn btn-primary btn-outline" 
				            		onclick="javascript:location.href='${basePath }providerBillDiscountListPage/${providerPhysicalChannel.id}'">返回</button>
				            	<button type="button" class="btn btn-primary" onclick="setProvinceBillDicount();">保存</button> 
				            	<button type="button" class="btn btn-success btn-outline" style="visibility: hidden;" id="showProviderBillDiscountList"
				            		onclick="javascript:location.href='${basePath }providerBillDiscountListPage/${providerPhysicalChannel.id}'">查看详情</button>
				            </div>
				        </div>
					</div>
  ...
  <script src="${basePath }js/project/mp/providerBillDiscountAdd.js"></script>
