...
<body>
			...
			<div class="row wrapper border-bottom white-bg page-heading" id="breadcrumbsDiv">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li><a>系统</a></li>
						<li class="active"><strong>话费代理账单统计</strong></li>
					</ol>
				</div>
			</div>
	...
	<script type="text/javascript" charset="UTF-8" src="${basePath }js/project/mp/agentBillStatementList.js"></script>
</body>
</html>
