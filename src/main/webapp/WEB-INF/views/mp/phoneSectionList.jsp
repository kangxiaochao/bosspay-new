...
<body>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row wrapper border-bottom white-bg page-heading" id="breadcrumbsDiv">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li><a>系统管理</a></li>
						<li class="active"><strong>号段列表</strong></li>
					</ol>
				</div>
			</div>
			...
			<div class="wrapper wrapper-content animated fadeInRight ecommerce">
						...
						<form class="form-horizontal">
							<div class="col-md-4">
		                        <div class="form-group">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="section" name="section" placeholder="请输入号段名称" class="form-control">
		                            </div>
		                        </div>
		                    </div>
		                    <div class="col-md-4">
		                        <div class="form-group">
		                            <label class="col-md-2 control-label" for="price">运营商</label>
		                            <div class="col-md-9">
			                            <input type="text" id="providerName" name="providerName" placeholder="请输入运营商名称" class="form-control">
		                            </div>
		                        </div>
		                    </div>
		                    <div class="col-md-4">
				...
				<div class="ibox-content m-b-sm border-bottom">
					<div class="row">
						<div class="col-md-12">
							<shiro:hasPermission name="phoneSectionAddPage:get"><button type="button" class="btn btn-primary" onclick="add()">添加</button></shiro:hasPermission>
							<shiro:hasPermission name="phoneSectionDetail:get"><button type="button" class="btn btn-primary btn-outline" onclick="detailEx()">详情</button></shiro:hasPermission>
	...
	<script type="text/javascript" charset="UTF-8" src="${basePath }js/project/mp/phoneSectionList.js"></script>
</body>
</html>
