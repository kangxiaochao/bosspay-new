        ...
        <div class="row wrapper border-bottom white-bg page-heading" id="breadcrumbsDiv">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a>系统管理</a></li>
                    <li class="active"><strong>Cookies刷新列表</strong></li>
                </ol>
            </div>
        </div>
                    ...
                    <%--<form class="form-horizontal">--%>
                        ...
                        <%--<div class="col-md-6">--%>
                            <%--<div class="form-group">--%>
                                ...
                                <%--<div class="col-md-9">--%>
                                    <%--<input type="text" id="title" name="title" value="" placeholder="请输入IP地址" class="form-control">--%>
                                <%--</div>--%>
                            <%--</div>--%>
                        <%--</div>--%>
                        <%--<div class="col-md-12">--%>
...
<script type="text/javascript" charset="UTF-8" src="${basePath }js/project/mp/cookiesList.js"></script>
</body>
</html>
