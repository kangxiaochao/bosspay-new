...
<!-- 	        <li id="p15"> <a href="${basePath }swagger-ui.html">springfox-swagger</a></li> -->
        ...
        <li id="p2">
	        ...
	        <ul class="nav nav-second-level" id="p2u">
		        ...
		        <shiro:hasPermission name="phonePhycicalchannelListPage:get"> <li id="p211"><a href="${basePath }phonePhycicalchannelListPage">通道号段管理</a></li></shiro:hasPermission>
...
<%-- 		        <shiro:hasPermission name="providerDataRechargeGroupList:get"> <li id="p26"><a href="${basePath }providerDataRechargeGroupList">复充话费通道组</a></li></shiro:hasPermission>
 --%>	        
        ...
        <li id="p3">
	        ...
	        <shiro:hasPermission name="queryExceptionOrderStatus:get"><li id="p39"> <a href="${basePath }queryOrderStatusPage" target="_blank">异常订单状态查询</a></li></shiro:hasPermission>
