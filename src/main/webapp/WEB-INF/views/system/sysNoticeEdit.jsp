      ...
      <div class="row wrapper border-bottom white-bg page-heading">
          <div class="col-lg-10"><br/>
		      <ol class="breadcrumb">
				  ...
				  <li><a>系统管理</a></li>
				  <li class="active"><strong>公告添加</strong></li>
			  </ol>
		  </div>
	  </div>
...
<div class="ibox float-e-margins">
    ...
    <form id="fm" action="${basePath }sysNotice" class="form-horizontal">
        <div class="form-group"><label class="col-sm-2 control-label">标题</label>
            <div class="col-sm-9">
            	<input type="hidden" name="id" id="id" value="${sysNotice.id}">
            	<input type="text" class="form-control" name="title" id="title" value="${sysNotice.title }" required>
            </div>
        </div>
        
        <div class="form-group"><label class="col-sm-2 control-label">副标题</label>
            <div class="col-sm-9">
            	<input type="text" class="form-control" name="subtitle" id="subtitle" value="${sysNotice.subtitle }" >
            </div>
        </div>
        
        <div class="form-group"><label class="col-sm-2 control-label">公告内容</label>
            <div class="col-sm-9">
            	<input type="hidden" class="form-control" name="content" id="content" value="${sysNotice.content }">
        ...
        <div class="form-group"><label class="col-sm-2 control-label">显示顺序</label>
            <div class="col-sm-9"><input type="number" class="form-control" name="order" id="order" value="${sysNotice.order }" required step="1"></div>
        </div>
        
        <div class="form-group">
            <div class="col-sm-4 col-sm-offset-2">
            	<button type="button" class="btn btn-primary btn-outline" onclick="javascript:location.href='${basePath }sysNoticeListPage'">返回</button>
  ...
  <script src="${basePath }js/project/sysNoticeEdit.js"></script>
