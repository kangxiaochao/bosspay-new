...
public class HyfdBillDeal implements com.hyfd.deal.BaseDeal{
	...
	public Map<String,Object> deal(Map<String, Object> order) {
		...
		try {
            ...
            String submitUrl = (String) channel.get("link_url");
            String privateKey = paramMap.get("privateKey");//私钥
			...
			String spec = (String) order.get("fee");//获取消费金额,以分为单位
			String orderType = "1";//业务类型 1是流量 2是话费
			Map<String,Object> pkg = (Map<String, Object>) order.get("pkg");
			// 适用范围，1是省内，2是国内
            String dataType = (String)pkg.get("data_type");
			String scope = dataType.equals("2")?"nation":"province";//适用范围（默认nation）
