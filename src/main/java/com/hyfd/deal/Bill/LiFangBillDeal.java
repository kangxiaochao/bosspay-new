...
public class LiFangBillDeal implements BaseDeal{
...
//			
			// 生成自己的id，供回调时查询数据使用
			String curids = systemId + ToolDateTime.format(new Date(), "yyyyMMddHHmmssSSS")
					+ (RandomUtils.nextInt(9999999) + 10000000);
			
			Map<String, String> sendmap = null;
//					charge(linkUrl, apiKey, curids, systemId, userName, userPwd, dealerId, phone,
...
//				}
	...
	public static void main(String[] args) {
		...
		LiFangBillDeal xingMeiBillDeal = new LiFangBillDeal();
