...
@Component
public class GongXiangTongXinTask {
	...
	public void queryPengBoShiOrder() {
		...
		try {
			String id = "2000000068";// 共享通信物理通道ID
			...
			for (Map<String, Object> order : orderList) {
				...
				if (null != data && !data.equals("")){
					...
					log.error("共享通信查单出错,订单号:"+orderId);
				}
			}
		} catch (Exception e) {
			log.error("共享通信Task出错" + e);
		}
	}
