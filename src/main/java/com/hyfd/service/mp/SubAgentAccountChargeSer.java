...
import com.hyfd.dao.mp.SubAgentAccountChargeDao;
...
@Service
public class SubAgentAccountChargeSer extends BaseService{
	 ...
	 * @return
	 */
	public int getSubAgentAccountChargeCount(Map<String, Object> m)
	{
		int agentCount = 0;
		try
		{
			agentCount = subAgentAccountChargeDao.selectCount(m);
		}
		catch (Exception e)
		{
			getMyLog(e, log);
	 ...
	 * @return
	 */
	public String subAgentAccountChargeList(HttpServletRequest req) {
		...
		try
		{
			...
			int total = getSubAgentAccountChargeCount(m);
			p.setCount(total);
			...
			List<Map<String, Object>> billList = subAgentAccountChargeDao.selectAll(m);
	...
	public void subAgentAccountChargeExport(HttpServletRequest req, HttpServletResponse resp) {
		...
		map.put("list", list);
		exportExcel("subAgentAccountCharge", "subAgentAccountCharge", map, req, resp);
	}
