...
public class MyRealm extends AuthorizingRealm{
	...
	@Autowired
	SysUserRoleSer sysUserRoleService;
	
	@Autowired
	SysRolePermissionSer sysRolePermissionService;
...
////        if(user!=null){
        	String suId=(String)userData.get("suId");
            //权限信息对象info,用来存放查出的用户的所有的角色（role）及权限（permission）  
            SimpleAuthorizationInfo info=new SimpleAuthorizationInfo();
            
            List<Map<String, Object>> sysUserRoleList=sysUserRoleService.getSysUserRoleListBySuId(suId);
            ...
            for(Map<String, Object> sysUserRole:sysUserRoleList){
            	...
            	List<Map<String, Object>> sysRolePermissionList=sysRolePermissionService.getSysRolePermissionBySrId(srId);
