...
<body>
			...
			<div class="row wrapper border-bottom white-bg page-heading" id="breadcrumbsDiv">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li><a>系统</a></li>
						<li class="active"><strong>余额核查</strong></li>
					</ol>
				</div>
			</div>
						...
						<div class="row">
		                    ...
		                    <div class="col-md-12">
		                    	<div class="text-center">
		                    		...
		                    		<button type="button" class="btn btn-primary" onclick="exportExcel()">导出报表</button>
		                    	</div>
		                    </div>
	                    </div>
                    </form>
    ...
    <script src="${basePath }js/project/mp/checkBalance.js"></script>
</body>
</html>