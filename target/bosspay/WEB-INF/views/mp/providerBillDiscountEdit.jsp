...
<body>
		...
		<div class="row wrapper border-bottom white-bg page-heading">
          <div class="col-lg-10"><br/>
		      <ol class="breadcrumb">
				  ...
				  <li><a>运营商</a></li>
				  <li><a>运营商物理通道</a></li>
				  <li class="active"><strong>修改话费包折扣</strong></li>
			  </ol>
		  </div>
		</div>
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
				        ...
				        <div class="form-group">
				            ...
				            <div class="form-group col-sm-11">
				            	<select required data-placeholder="请选择..." class="chosen-select" name="provinceCode" id="provinceCode" onchange="getProviderBillPkg()">
  ...
  <script src="${basePath }js/project/mp/providerBillDiscountEdit.js"></script>
