...
<body>
			...
			<div class="row wrapper border-bottom white-bg page-heading" id="breadcrumbsDiv">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li><a>系统</a></li>
						<li class="active"><strong>订单流水列表</strong></li>
					</ol>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-md-2" >
		                        <div class="form-group">
		                            <label class="control-label" for="">开始时间s</label>
		                    ...
		                    <div class="col-md-2" >
		                     ...
		                     <div class="col-md-2" >
		                        <div class="form-group">
		                            ...
		                            <input type="text" id="mpOrderId" name="mpOrderId" value="" placeholder="请输入订单号" class="form-control" 
		                            maxlength="50">
		                        </div>
		                    </div>
		                    <div class="col-md-2" >
	...
	<script type="text/javascript" charset="UTF-8" src="${basePath }js/project/mp/orderPathRecordList.js"></script>
</body>
</html>
