...
<body>
					...
					<div class="ibox-content">
						<form id="fm" method="post" action="${basePath }phoneSection" class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="tel" class="form-control" name="section" id="section" data-mask="9999999" onchange="checkPhone(this.value)" required>
								</div>
							...
							<div class="form-group">
								<div class="col-md-4 col-md-offset-2">
									...
									<shiro:hasPermission name="phoneSection:post"><button type="submit" id="submit" class="btn btn-primary">增加</button></shiro:hasPermission>
								</div>
							</div>
						</form>
	...
	<script src="${basePath }js/project/mp/phoneSectionAdd.js"></script>
</body>
</html>