...
<body>
						...
						<form class="form-horizontal">
							<div class="col-md-6">
		                        <div class="form-group">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="pname" name="pname" value="" placeholder="请输入话费折扣名称" class="form-control">
		                            </div>
		                        </div>
		                    </div>
		                    <div class="col-md-12">
	...
	<script type="text/javascript" charset="UTF-8" src="${basePath }js/project/mp/dataDiscountModelDetail.js"></script>
</body>
</html>
