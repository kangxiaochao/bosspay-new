      ...
      <div class="row wrapper border-bottom white-bg page-heading">
          <div class="col-lg-10"><br/>
		      <ol class="breadcrumb">
				  ...
				  <li><a>资源配置</a></li>
				  <li class="active"><strong>物理通道对应的消息队列通道添加</strong></li>
			  </ol>
		  </div>
	  </div>
...
<div class="ibox float-e-margins">
    ...
    <h5><small>物理通道对应的消息队列通道添加</small></h5>
    ...
    <form id="fm" method="post" action="${basePath }rabbitmqPhysicalChannel" class="form-horizontal" onsubmit="setMqQueueDisplayName()">
        <div class="form-group">
			<label class="col-md-2 control-label">物理通道</label>
			<div class="col-md-8">
				<select class="chosen-select"  name="providerPhysicalChannelId" id="providerPhysicalChannelId"></select>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				...
				<input type="hidden" id="mqqueuedisplayname" name="mqqueuedisplayname" value="备用通道1">
			</div>
		</div>
        <div class="form-group">
  ...
  <script src="${basePath }js/project/mp/rabbitmqPhysicalChannelAdd.js"></script>
