...
<body>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row wrapper border-bottom white-bg page-heading" id="breadcrumbsDiv">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li><a>运营商物理通道</a></li>
						<li class="active"><strong>运营商物理通道话费折扣上传</strong></li>
					</ol>
				</div>
			</div>
			...
			<div class="wrapper wrapper-content animated fadeInRight ecommerce" id="selectId" data-id="${1 }">
						...
						<div class="col-md-12">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label class="col-md-4 control-label">物理通道</label>
									<div class="col-md-8">
										<select class="chosen-select"  name="physicalId" id="physicalId"></select>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label class="col-md-4 control-label">运营商</label>
									<div class="col-md-8">
				...
				<!-- <div class="ibox-content m-b-sm border-bottom">
					<div id="discountDiv" class="row"  style="display:none">
						<div class="col-md-12">
							<div class="col-md-3">
								<div class="form-group">
									<label class="col-md-4 control-label">全国扣款折扣</label>
									<div class="col-md-8">
										<input id="virtualProviderDiscount" name = "virtualProviderDiscount" type='text' placeholder='请输入全国统一折扣' class='form-control'>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<label class="col-md-4 control-label">全国返利折扣</label>
								<div class="col-md-8">
									<input id="virtualProviderRealDiscount" name = "virtualProviderRealDiscount" type='text' placeholder='请输入全国统一折扣' class='form-control'>
								</div>
							</div>
							<div class="col-xs-1">
				...
				<div class="ibox-content m-b-sm border-bottom">
					<input id="virtualProviderDiscount" type="hidden">
					<div id="discountDiv" ></div>
					<div id="realDiscountDiv" ></div>
					<div id="mytbc1"></div>
				</div>
			</div>
	...
	<script type="text/javascript" charset="UTF-8" src="${basePath }js/project/mp/providerBillDiscountUpload.js"></script>
