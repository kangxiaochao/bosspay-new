...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row wrapper border-bottom white-bg page-heading" id="breadcrumbsDiv">
				<div class="col-lg-10">
					<h3>物理通道对应的消息队列通道列表</h3>
					<ol class="breadcrumb">
						<li><a href="${basePath }mainPage">主页</a></li>
						<li><a>系统管理</a></li>
						<li class="active"><strong>物理通道对应的消息队列通道列表</strong></li>
					</ol>
				</div>
			</div>
						...
						<form class="form-horizontal">
							<div class="col-md-6">
		                        <div class="form-group">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="name" name="name" value="" placeholder="请输入物理通道名称" class="form-control">
		                            </div>
		                        </div>
		                    </div>
							<div class="col-md-6">
		                        <div class="form-group">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="mqqueuedisplayname" name="mqqueuedisplayname" value="" placeholder="请输入消息队列通道名称" class="form-control">
		                            </div>
		                        </div>
		                    </div>
		                    <div class="col-md-12">
	...
	<script type="text/javascript" charset="UTF-8" src="${basePath }js/project/mp/rabbitmqPhysicalChannelList.js"></script>
</body>
</html>
