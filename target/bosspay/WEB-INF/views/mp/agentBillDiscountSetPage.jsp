...
<body>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="wrapper wrapper-content animated fadeInRight ecommerce" id="selectId" data-id="${1 }">
						...
						<div class="col-md-12">
							<div class="col-md-2">
								<div class="form-group">
									<label class="col-md-8">代理商</label>
									<div>
							...
							<div class="col-md-2">
								<div class="form-group">
									<label class="col-md-8">运营商</label>
									<div>
							...
							<div class="col-xs-1">
								...
								<button type="button" class="btn btn-primary" onclick="searcher()">查询</button>
							</div>
							...
							<div class="col-md-2">
								<div class="form-group">
									<label class="col-md-8">折扣来源代理商</label>
									<div>
										<select class="chosen-select"  name="agentIdSource" id="agentIdSource"></select>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-1">
								<label class="col-md-8">　</label>
								<button type="button" class="btn btn-primary" onclick="copyBillPkgDiscout()">复制</button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="ibox-content m-b-sm border-bottom">
					<input id="virtualProviderDiscount" name = "virtualProviderDiscount" type="hidden">
	...
	<script type="text/javascript" charset="UTF-8" src="${basePath }js/project/mp/agentBillDiscountSet.js"></script>
