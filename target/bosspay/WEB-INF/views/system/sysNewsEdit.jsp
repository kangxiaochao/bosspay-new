...
<div class="ibox float-e-margins">
    ...
    <form id="fm" action="${basePath }sysNews" class="form-horizontal">
        <div class="form-group"><label class="col-sm-2 control-label">标题</label>
            <div class="col-sm-9">
            	<input type="hidden" name="id" id="id" value="${sysNews.id}">
            	<input type="text" class="form-control" name="title" id="title" value="${sysNews.title }" required>
            </div>
        </div>
        
        <div class="form-group"><label class="col-sm-2 control-label">副标题</label>
            <div class="col-sm-9">
            	<input type="text" class="form-control" name="subtitle" id="subtitle" value="${sysNews.subtitle }" >
            </div>
        </div>
        
        <div class="form-group"><label class="col-sm-2 control-label">新闻内容</label>
            <div class="col-sm-9">
            	<input type="hidden" class="form-control" name="content" id="content" value="${sysNews.content }">
        ...
        <div class="form-group"><label class="col-sm-2 control-label">显示顺序</label>
            <div class="col-sm-9"><input type="number" class="form-control" name="order" id="order" value="${sysNews.order }" required step="1"></div>
        </div>
  ...
  <script src="${basePath }js/project/sysNewsEdit.js"></script>
