...
<div class="ibox float-e-margins">
    ...
    <form id="fm" method="post" action="${basePath }sysNotice" class="form-horizontal">
        ...
        <div class="form-group"><label class="col-sm-2 control-label">公告类型</label>
            <div class="col-sm-9">
				<select class="chosen-select" id="order" name="order" >
  ...
  <script src="${basePath }js/project/sysNoticeAdd.js"></script>
